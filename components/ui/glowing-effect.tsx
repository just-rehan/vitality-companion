    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          const mouseX = (e as MouseEvent)?.clientX ?? (e as {x: number})?.x ?? lastPosition.current.x;
          const mouseY = (e as MouseEvent)?.clientY ?? (e as {y: number})?.y ?? lastPosition.current.y;
